...
extension Combine.Publishers.ControlEvent {
    private final class Subscription<S: Subscriber, InterfaceControl: UIControl>: Combine.Subscription
    where S.Input == Void {
        private var subscriber: S?
        weak private var control: InterfaceControl?
        
        init(subscriber: S, control: InterfaceControl, event: InterfaceControl.Event) {
